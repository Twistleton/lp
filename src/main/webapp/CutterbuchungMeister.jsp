...
<html>
<head><title>Cutterbuchung Meistersicht</title>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8" />
</head>
<body>

<h1 class="title">Cutterbuchung #${sessionScope.id} für Team ${team} - Meistersicht - Status ${cutterzuweisungsstatus}</h1>
<div class="hintergrund">
    <table border="1" width="100%" height="100px">
        ...
        <tr>
            <form action="CutterbuchungMeister.do" method="POST">
            <td align="left">
               <%@ include file="Hautinfo.jsp" %>
               <p align="center">
               <input type="submit" name="berechnen"     value="Neuberechnung">
               <input type="submit" name="pruefen"       value="Grund ändern">
               <input type="submit" name="zuruecksetzen" value="Status zurücksetzen">
               <input type="submit" name="freigeben"     value="Buchung und Freigabe">
               <input type="submit" name="loeschen"      value="löschen">
               <a href="/lp/CutterzuweisungList.do?team=${team}&vonstatus=20&bisstatus=20&meister=1">Übersichtsliste</a>
               &nbsp;&nbsp;Kontrollbeleg  an &nbsp;
               <select name="drucker">
        ...
        <form name="formkomentar" action="CutterbuchungMeister.do" method="POST">
        <tr>
            <td>
                <%@ include file="Kommentarzeile.jsp" %>
            </td>
        </tr>
        </form>
    </table>
